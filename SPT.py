...
Original file is located at
    https://colab.research.google.com/drive/10m_VSlxMY2vdrj7ilGKnfe3xFOVjk9UO
"""
...
class SPT:
    ...
    # Tinh cac chi so va thu tu cong viec theo SPT
    def calculate(self):
        # Sắp xếp danh sách công việc theo quy tắc SPT
        self.list_work = sorted(self.list_work, key = lambda x: x.time_work)
